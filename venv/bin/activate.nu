...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/atreyee/Downloads/day-69-starting-files-blog-with-users/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/atreyee/Downloads/day-69-starting-files-blog-with-users/venv/bin/deactivate.nu'
